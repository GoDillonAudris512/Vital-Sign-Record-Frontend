                ...
                <div class="mt-3">
                    ...
                    <div class="flex flex-row">
                        <div class="flex flex-row items-center w-1/2">
                            ...
                            <input type="number" id="systolic" v-model="systolic" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter your systolic pressure"></input>
                        </div>
                        <p class="text-[1.2rem] mx-2">/</p>
                        <div class="flex flex-row items-center w-1/2">
                            <label for="diastolic" class="block text-base"></label>
                            <input type="number" id="diastolic" v-model="diastolic" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter your diastolic pressure"></input>
                        </div>
                    </div> 
                </div>
                <div class="mt-3">
                    <label for="heartbeat" class="block text-base mb-2">Heartbeat</label>
                    <input type="number" id="heartbeat" v-model="heartbeat" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter your heartbeat (per minute)"></input>
                </div>
                <div class="mt-3">
                    <label for="respiratory" class="block text-base mb-2">Respiratory Rate</label>
                    <input type="number" id="respiratory" v-model="respiratory" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter your respiratory rate (per minute)"></input>
                </div>
                <div class="mt-3">
                    <label for="temperature" class="block text-base mb-2">Temperature</label>
                    <input type="number" step="0.01" id="temperature" v-model="temperature" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter your temperature (&deg;C)"></input>
                </div>
